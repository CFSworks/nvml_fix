...
`TARGET_VER=430.40` is:  
  * `make TARGET_VER=430.40`  
...
`make install libdir=/path/to/lib`:  
  * `sudo make install TARGET_VER=430.40 libdir=/usr/lib/x86_64-linux-gnu`  
...
The current Makefile defaults are `TARGET_VER=430.40 libdir=/usr/lib/x86_64-linux-gnu`.  
